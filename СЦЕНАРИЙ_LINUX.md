...
curl "http://192.168.1.100:8080/logs?severity=err&limit=10"

# Получаем логи за последний час
curl "http://192.168.1.100:8080/logs?since=2024-01-15T13:00:00&limit=50"

# Получаем логи конкретного хоста
curl "http://192.168.1.100:8080/logs?host=ubuntu-server&limit=20"
```
...
curl "http://192.168.1.100:8080/logs?limit=1" | grep "Тестовое сообщение"
```
